...
const applyExtremo = [
  ...
  // ELIMINADO: net_throttle (Pasa a Red Avanzada)
  // ELIMINADO: net_tcp_advanced (Pasa a Red Avanzada)
...
const revertExtremo = [
  ...
  // ELIMINADO: net_throttle revert
  // ELIMINADO: net_tcp_advanced revert
